        ...
        <div className='cards__wrapper'>
          ...
          <div data-aos="fade-down-right"  className='dummy'>
            <CardItem label='Strong knowledge of the African market:'>
             ...
             <li className='li'>We know how and where to find the best talent for each job.</li>
              <li className='li'>We meet all the needs of our workers to help them perform at their best: laptops, access to an internet connection, and paid access to coworking space.</li>
              </ul>
            </CardItem>
            </div>
          ...
          <div data-aos="fade-up-right" className='dummy'>
            ...
            <li className='li'>We provide our engineers with paid language courses and development certificates.</li>
